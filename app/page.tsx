...
export default async function Home() {
  ...
  return <>
    ...
    <main id="top">
      ...
      <section className="journal section" id="journal" aria-labelledby="journal-title"><div className="section-head row"><div><p className="eyebrow">04 — Journal</p><h2 id="journal-title">From the <em>workshop.</em></h2></div><a className="text-link" href="#journal">All notes <span>↗</span></a></div>
